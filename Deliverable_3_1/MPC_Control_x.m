classdef MPC_Control_x < MPC_Control
    ...
    methods
        ...
        function ctrl_opti = setup_controller(mpc, Ts, H)
            ...
            xlabel("$\omega_y$ [rad/s]", "interpreter", "latex")
            ylabel("$\beta$ [rad]", "interpreter", "latex")
            title("$X_f$ of $sys_x$ projected onto 1st and 2nd dimension", "interpreter","latex")
            
            subplot(2,3,2)
            Xf.projection(2:3).plot();
            xlabel("$\beta$ [rad]", "interpreter", "latex")
            ylabel("$v_x$ [m/s]", "interpreter", "latex")
            title("$X_f$ of $sys_x$ projected onto 2nd and 3rd dimension", "interpreter","latex")
            
            subplot(2,3,3)
            Xf.projection(3:4).plot();
            xlabel("$v_x$ [m/s]", "interpreter", "latex")
            ylabel("$x$ [m]", "interpreter", "latex")
            title("$X_f$ of $sys_x$ projected onto 3rd and 4th dimension", "interpreter","latex")
