...
%% Define MPC controllers, simulate and plot results
% sys_x
...
ph_y = rocket.plotvis_sub(T, X_sub, U_sub, sys_y, xs, us);
...
ph_z = rocket.plotvis_sub(T, X_sub, U_sub, sys_z, xs, us);
...
ph_roll = rocket.plotvis_sub(T, X_sub, U_sub, sys_roll, xs, us);
